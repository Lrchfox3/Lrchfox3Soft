 ...
 */
public class JBotonAgregar extends javax.swing.JButton {
    ...
    public void inicializar() {           
        ...
        setIcon(new ImageIcon(getClass().getResource(propiedades.getImgAgregar())));
        setAlignmentX(0);
        setAlignmentY(0);        
