 ...
 * </pre></code>
 */
public class JSplitButton extends JMenuExtendido implements ButtonStyle, ComponentStateSupport {
    ...
    public JSplitButton(String s) {
        super(s);
        initComponent();
    }

    public JSplitButton(String s, Icon icon) {
        super(s);
        setIcon(icon);
        initComponent();
    }
