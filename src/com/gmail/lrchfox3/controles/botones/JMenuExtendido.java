...
import com.gmail.lrchfox3.utilitarios.SystemInfo;
 ...
 * <p/>
 */
public class JMenuExtendido extends JMenu implements Alignable {
    ...
    public JMenuExtendido() {
        initMenu();
    }

    public JMenuExtendido(String s) {
        super(s);
        initMenu();
    }

    public JMenuExtendido(Action a) {
        super(a);
        initMenu();
    }

    public JMenuExtendido(String s, boolean b) {
        super(s, b);
        initMenu();
    }
...
//        setDelay(DELAY);
    ...
    public interface PopupMenuOriginCalculator {
        Point getPopupMenuOrigin(JMenuExtendido menu);
    }
    ...
    /*protected Point getPopupMenuOrigin() {
        ...
        if (parent instanceof JPopupMenu) {
            ...
            if (this.getComponentOrientation().isLeftToRight()) {
                if (Utileria.getOrientationOf(this) == HORIZONTAL) {
                    // First determine x:
    ...
    private static JMenuExtendido _pendingMenu;
