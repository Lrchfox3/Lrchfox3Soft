 ...
 */
public class JBotonVentanaEditar extends javax.swing.JButton {
    ...
    public void inicializar() {           
        ...
        setIcon(new ImageIcon(getClass().getResource(propiedades.getImgVentanaEditar())));        
        setAlignmentX(0);
        setAlignmentY(0);        
