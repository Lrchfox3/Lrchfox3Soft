...
public class JBotonOvalo extends JButton implements Serializable {
...
// <editor-fold defaultstate="collapsed" desc=" Declaración de Variables ">
    ...
    private int opcionDibujo = OpcionesDibujo.OVALO;
// </editor-fold>
    ...
    public void inicializar() {
        //setText("Rectángulo");
        setToolTipText("Ovalo");
        setFont(propiedades.getFontBotones());
        setIcon(new ImageIcon(propiedades.getImgOvalo()));
        setAlignmentX(0);
        setAlignmentY(0);
