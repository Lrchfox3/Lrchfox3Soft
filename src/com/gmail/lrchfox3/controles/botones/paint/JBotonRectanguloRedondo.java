...
public class JBotonRectanguloRedondo extends JButton implements Serializable {
...
// <editor-fold defaultstate="collapsed" desc=" Declaración de Variables ">
    ...
    private int opcionDibujo = OpcionesDibujo.RECTANGULO_REDONDO;
// </editor-fold>

    public JBotonRectanguloRedondo() {
        inicializar();
    }

    public void inicializar() {
        //setText("Rectángulo");
        setToolTipText("Rectángulo Redondeado");
        setFont(propiedades.getFontBotones());
        setIcon(new ImageIcon(propiedades.getImgRectanguloRedondo()));
        setAlignmentX(0);
        setAlignmentY(0);
