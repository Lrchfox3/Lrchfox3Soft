...
public class JBotonPoligono extends JButton implements Serializable {
...
// <editor-fold defaultstate="collapsed" desc=" Declaración de Variables ">
    ...
    private int opcionDibujo = OpcionesDibujo.POLIGONO;
// </editor-fold>

    public JBotonPoligono() {
        inicializar();
    }

    public void inicializar() {
        //setText("Rectángulo");
        setToolTipText("Polígono");
        setFont(propiedades.getFontBotones());
        setIcon(new ImageIcon(propiedades.getImgPoligono()));
        setAlignmentX(0);
        setAlignmentY(0);
