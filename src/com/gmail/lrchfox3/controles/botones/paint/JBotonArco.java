...
public class JBotonArco extends JButton implements Serializable {
...
// <editor-fold defaultstate="collapsed" desc=" Declaración de Variables ">
    ...
    private int opcionDibujo = OpcionesDibujo.ARCO;
// </editor-fold>
    ...
    public void inicializar() {
        ...
        setIcon(new ImageIcon(propiedades.getImgArco()));
        setAlignmentX(0);
        setAlignmentY(0);
