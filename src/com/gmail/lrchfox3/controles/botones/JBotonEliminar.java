 ...
 */
public class JBotonEliminar extends javax.swing.JButton {
    ...
    public void inicializar() {           
        ...
        setIcon(new ImageIcon(getClass().getResource(propiedades.getImgEliminar())));        
        setAlignmentX(0);
        setAlignmentY(0);        
   ...
   public void mostrarTexto() {
        setText(Propiedades.appBundle.getString("ELIMINAR"));
        setSize(26, 106);        
   }    
   
        public int getAccion(){
       return BD.ACCION_ELIMINAR;
   }
}
