...
public class CheckBoxListCellRenderer extends JPanel implements ListCellRenderer, Serializable {
    ...
    public Component getListCellRendererComponent(JList list,
        ...
        Object actualValue;
        if (list instanceof JCheckBoxList) {
            CheckBoxListSelectionModel selectionModel = ((JCheckBoxList) list).getCheckBoxListSelectionModel();
            if (selectionModel != null) {
                boolean enabled = list.isEnabled()
                        && ((JCheckBoxList) list).isCheckBoxEnabled()
                        && ((JCheckBoxList) list).isCheckBoxEnabled(index);
        ...
        if (_actualListRenderer != null) {
            ...
            if (list instanceof JCheckBoxList) {
                if (!((JCheckBoxList) list).isCheckBoxVisible(index)) {
                    return listCellRendererComponent;
                }
            }
    ...
    private String convertElementToString(Locale locale, Object value) {
        if (JCheckBoxList.ALL_ENTRY.equals(value)) {
