...
public class JCheckBoxList extends JList {
    ...
    protected void init() {
        ...
        Utileria.insertMouseListener(this, _handler, 0);
    ...
    protected static class Handler implements MouseListener, KeyListener, ListSelectionListener, PropertyChangeListener, ListDataListener {
        protected JCheckBoxList _list;
        int hotspot = new JCheckBox().getPreferredSize().width;


        public Handler(JCheckBoxList list) {
            _list = list;
        }
    ...
    public Dimension getPreferredScrollableViewportSize() {
        ...
        return size != null && size.width > 0 && size.height > 0 ? Utileria.adjustPreferredScrollableViewportSize(this, size) : size;
