...
public abstract class ActionTableCellEditor implements TableCellEditor, ActionListener {
    //public final Icon DOTDOTDOT_ICON = new ImageIcon(getClass().getResource("/ViewController/imagenes/dotdotdot.png"));
    ...
    public ActionTableCellEditor(TableCellEditor editor) {
        ...
        customEditorButton.setFont( new Font("Segoe UI", Font.PLAIN, 10) );        
    }
