...
abstract class Tree
{  static final int
      ERROR=0, ID=1, BRACKET=2, ADD=3, SUB=4, MUL=5, DIV=6, POW=7;
   ...
   static Tree build2(int kind, Tree node1, Tree node2)
   {  switch (kind)
      {
   ...
   static class Error extends Tree
   {  String message;
      int start, end;
      Error(int s, int e) { start = s; end = e; }
      int getKind() { return ERROR; }
   ...
   static class Id extends Tree
   {  int ref, start;
      Id(int r, int s) { ref = r; start = s; }
      int getKind() { return ID; }
      int getPrefix() { return 0; }
      int getPostfix() { return 0; }
   }
   ...
   static class Bracket extends Tree
   {  Tree expr;
      Bracket(Tree e) { expr = e; }
      int getKind() { return BRACKET; }
   ...
   {  Tree left, right;
      Add(Tree l, Tree r) { left = l; right = r; }
      int getKind() { return ADD; }
      int getPrefix() { return 0; }
      int getPostfix() { return 0; }
   }

   static class Sub extends Tree
   {  Tree left, right;
      Sub(Tree l, Tree r) { left = l; right = r; }
      int getKind() { return SUB; }
      int getPrefix() { return 0; }
      int getPostfix() { return 0; }
   }
   ...
   {  Tree left, right;
      Mul(Tree l, Tree r) { left = l; right = r; }
      int getKind() { return MUL; }
      int getPrefix() { return 0; }
      int getPostfix() { return 0; }
   }

   static class Div extends Tree
   {  Tree left, right;
      Div(Tree l, Tree r) { left = l; right = r; }
      int getKind() { return DIV; }
      int getPrefix() { return 0; }
      int getPostfix() { return 0; }
   }

   static class Pow extends Tree
   {  Tree left, right;
      Pow(Tree l, Tree r) { left = l; right = r; }
      int getKind() { return POW; }
      int getPrefix() { return 0; }
      int getPostfix() { return 0; }
   }
}
