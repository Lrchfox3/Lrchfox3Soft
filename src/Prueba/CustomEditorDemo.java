...
public class CustomEditorDemo extends JFrame {
    ...
    public CustomEditorDemo() {
        ...
        JTable table = new JTable(new Object[][]{{"JavaTutorial", "This is sun's java tutorial.\nthis is best for beginners"}, {"JavaSwing", "This is book dedicated to swing.\nIt covers in-depth knowledge of swing"}, {"", ""}}, new String[]{"Title of Book", "Description of Book"});
